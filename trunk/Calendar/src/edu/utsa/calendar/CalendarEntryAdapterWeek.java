...
/**
 * This class extends base adapter class and will be responsible for drawing
 * textbox in the grid weekly view
 * 
 * @author Jamiul
 * 
 */
...
public class CalendarEntryAdapterWeek extends BaseAdapter {
	 ...
	 *            context
	 * @param text
	 *            texts need to put in the adapter
	 * @param color
	 *            category color for events
	 */
